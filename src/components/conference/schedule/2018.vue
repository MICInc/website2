	...
	<div>
		<!-- <div>
			...
			<div id="#guide-wrapper">
				<div class="guide">
					<div class="room-key">
						<p class="mpr room-icon"></p>Multi-purpose Room
					</div>
					<div class="room-key">
						<p class="ssr room-icon"></p>Silverman Skyline Room
					</div>
					<div class="room-key">
						<p class="lh room-icon"></p>Lecture Hall
					</div>
					<div class="room-key">
						<p class="wgr room-icon"></p>Winter Garden Room
					</div>
				</div>
			</div>
			<div class="event" :class="event.type" v-for="(event, id) in schedule2018" :key="id">
				<div class="desc">
