	...
	<div>
		...
		<div>
			...
			<span v-if="speakers[person].title != null">
				...
				<p v-if="speakers[person].abstract != null">{{ speakers[person].abstract }}</p>
			</span>
		</div>
	</div>
</template>
		...
		return {
			...
			speakers: {
				...
				laurens_van_der_maaten: {
					...
					headshot: 'laurens_van_der_maaten.png'
				},

				lenny_grokop: {
					name: 'Lenny Grokop',
					bio: 'Software Engineer at Facebook: Community Integrity',
				},
				...
				shaman_ray_chaudhuri: {
					...
					headshot: 'shraman_chaudhuri.png',
				},
